...
const ProviderRegister = () => {
    ...
    const handleSubmit = () => {
        ...
        if (name.length === 0) {
            ...
            const url = `https://localhost:7193/api/Provider`

            const body = {
                    providerName: name ,
                    providerContact:mobile ,
                    providerEmail: email,
                    providerPassword: password,
                    providerAddress: address,
                    providerCity: city,
                    providerRegStatus: true
                ...
                <div className="col">
                    <div className="provider-form" style={{ boxShadow: "1px 3px 8px black", marginTop: "25%", padding: "20px" }}>
                        <div className="signup-heading" style={{ fontFamily: "sans-serif", fontSize: "30px" }}>
                            <span>Registration for Provider</span>
                        </div>
                        ...
                        <div className="navigate-login">
                            <span><b>Already registered ? </b><Link to='/signin/provider-signin'>Sigin here</Link></span>
                        </div>
